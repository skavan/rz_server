...
export const skus = pgTable('skus', {
  ...
  estRepairPrice: decimal('est_repair_price', { precision: 10, scale: 2 }),
...
export const issues = pgTable('issues', {
  ...
  replacePrice: decimal('replace_price', { precision: 12, scale: 2 }),
  repairPrice: decimal('repair_price', { precision: 12, scale: 2 }),
