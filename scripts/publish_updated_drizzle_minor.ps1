...
Run-Step -Title "Run shared release (minor)" -Action {
  npm run release:shared -- minor -- --note "$Note" --skip-clean-check
}
...
Write-Host ""
Write-Host "Done. Shared minor release flow completed." -ForegroundColor Green
